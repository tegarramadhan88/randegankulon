 ...
 */ !(function (t) {
  ...
  function (t, e) {
    (L.Control.BrowserPrint = L.Control.extend({
      ...
      onAdd: function (t) {
        this.options.customPrintStyle.pane &&
          !t.getPane(this.options.customPrintStyle.pane) &&
          (t.createPane(
            this.options.customPrintStyle.pane
          ).style.zIndex = 9999);
        ...
        return (
          ...
          this.options.printModes.length > 1
            ? (L.DomEvent.addListener(
                e,
                "mouseover",
                this._displayPageSizeButtons,
                this
              ),
              L.DomEvent.addListener(
                e,
          ...
          this.options.position.indexOf("left") > 0
            ? (this._createIcon(e), this._createMenu(e))
            : (this._createMenu(e), this._createIcon(e)),
          (t.printControl = this),
          e
        );
      },
      _createIcon: function (t) {
        return (
          (this.__link__ = L.DomUtil.create("a", "", t)),
      ...
      _createMenu: function (t) {
        for (var e = [], r = 0; r < this.options.printModes.length; r++) {
          ...
          if (n.length) {
            ...
            n = L.control.browserPrint.mode[n.toLowerCase()](
              this._getDefaultTitle(i)
            );
          } else if (!(n instanceof L.Control.BrowserPrint.Mode))
            throw "Invalid Print Mode. Can't construct logic to print current map.";
          1 == this.options.printModes.length
            ? (n.Element = t)
            : ((n.Element = L.DomUtil.create(
                "li",
                "browser-print-mode",
                L.DomUtil.create("ul", "browser-print-holder", t)
              )),
              (n.Element.innerHTML = n.Title)),
      ...
      _getDefaultTitle: function (t) {
        return (
          (this.options.printModesNames && this.options.printModesNames[t]) || t
        );
      },
      ...
      _getMode: function (t, e) {
        return new L.control.browserPrint.mode(
          t,
          e.Title,
          e.PageSize,
          e.Action,
      ...
      _printLandscape: function (t) {
        this._addPrintClassToContainer(
          this._map,
      ...
      _moveAutoPoligon: function (t) {
        this.options.custom &&
          (t.originalEvent.preventDefault(),
          t.originalEvent.stopPropagation(),
          this.options.custom.rectangle
            ? this.options.custom.rectangle.setBounds(
                L.latLngBounds(this.options.custom.start, t.latlng)
              )
            : ((this.options.custom.rectangle = L.rectangle(
                [this.options.custom.start, t.latlng],
                this.options.customPrintStyle
              )),
      ...
      _endAutoPoligon: function (t) {
        if (
          ...
          this.options.custom && this.options.custom.rectangle)
        ) {
      ...
      _getPageSizeFromBounds: function (t) {
        return Math.abs(t.getNorth() - t.getSouth()) >
          Math.abs(t.getEast() - t.getWest())
          ? "Portrait"
          : "Landscape";
      },
      ...
      _print: function (t, e) {
        this._map.fire(L.Control.BrowserPrint.Event.PrintInit, { mode: t }),
        ...
        var r = this,
          ...
          o = {
            ...
            printLayer: L.Control.BrowserPrint.Utils.cloneLayer(
        ...
        if (
          ((o.printObjects = this._getPrintObjects(o.printLayer)),
          this._map.fire(L.Control.BrowserPrint.Event.PrePrint, {
          ...
          this.cancelNextPrinting)
        )
          delete this.cancelNextPrinting;
        else {
          var l = this._addPrintMapOverlay(
            t.PageSize,
            t.getPageMargin("mm"),
            t.getSize(),
            i,
          ...
          this.options.documentTitle &&
            ...
            t.InvalidateBounds
              ? (l.map.fitBounds(o.bounds),
                l.map.invalidateSize({ reset: !0, animate: !1, pan: !1 }))
              : l.map.setView(this._map.getCenter(), this._map.getZoom());
          var p = setInterval(function () {
            r._isTilesLoading(l.map) ||
              (clearInterval(p),
              r.options.manualMode
                ? r._setupManualPrintButton(l.map, o, l.objects)
                : r._completePrinting(l.map, o, l.objects));
          }, 50);
        }
      },
      ...
      _getBoundsForAllVisualLayers: function () {
        ...
        for (var e in this._map._layers) {
          ...
          r._url ||
            ...
            (t
              ? r.getBounds
                ? t.extend(r.getBounds())
                : r.getLatLng && t.extend(r.getLatLng())
              : r.getBounds
              ? (t = r.getBounds())
              : r.getLatLng &&
                (t = L.latLngBounds(r.getLatLng(), r.getLatLng())));
        }
      ...
      _printEnd: function (t) {
        this._clearPrint(),
          ...
          this._map.invalidateSize({ reset: !0, animate: !1, pan: !1 });
      },
      ...
      _addPrintCss: function (t, e, r) {
        ...
        switch (
          ((n.className = "leaflet-browser-print-css"),
          n.setAttribute("type", "text/css"),
          (n.innerHTML =
            " @media print { .leaflet-popup-content-wrapper, .leaflet-popup-tip { box-shadow: none; }"),
          (n.innerHTML +=
            " .leaflet-browser-print--manualMode-button { display: none; }"),
          (n.innerHTML +=
            " * { -webkit-print-color-adjust: exact!important; printer-colors: exact!important; color-adjust: exact!important; }"),
          e && (n.innerHTML += " @page { margin: " + e + "; }"),
          (n.innerHTML += " @page :first { page-break-after: always; }"),
          r)
        ) {
          case "Landscape":
      ...
      _appendControlStyles: function (t) {
        ...
        e.setAttribute("type", "text/css"),
          (e.innerHTML +=
            " .leaflet-control-browser-print { display: flex; } .leaflet-control-browser-print a { background: #fff url('data:image/png;base64,') no-repeat 5px; background-size: 16px 16px; display: block; border-radius: 2px; }"),
          (e.innerHTML +=
            " .leaflet-control-browser-print a.leaflet-browser-print { background-position: center; }"),
          (e.innerHTML +=
            " .browser-print-holder { background-color: #919187; margin: 0px; padding: 0px; list-style: none; white-space: nowrap; align-items: center; display: flex; } .browser-print-holder-left li:last-child { border-top-right-radius: 2px; border-bottom-right-radius: 2px; } .browser-print-holder-right li:first-child { border-top-left-radius: 2px; border-bottom-left-radius: 2px; }"),
          (e.innerHTML +=
            " .browser-print-mode { display: none; color: #FFF; text-decoration: none; padding: 0 10px; text-align: center; } .browser-print-holder:hover { background-color: #757570; cursor: pointer; }"),
          (e.innerHTML +=
            " .leaflet-browser-print--custom, .leaflet-browser-print--custom path { cursor: crosshair!important; }"),
          (e.innerHTML +=
            " .leaflet-print-overlay { width: 100%; height:auto; min-height: 100%; position: absolute; top: 0; background-color: white!important; left: 0; z-index: 1001; display: block!important; } "),
          (e.innerHTML +=
            " .leaflet--printing { height:auto; min-height: 100%; margin: 0px!important; padding: 0px!important; } body.leaflet--printing > * { display: none; box-sizing: border-box; }"),
          (e.innerHTML +=
            " .grid-print-container { grid-template: 1fr / 1fr; box-sizing: border-box; } .grid-map-print { grid-row: 1; grid-column: 1; } body.leaflet--printing .grid-print-container [leaflet-browser-print-content]:not(style) { display: unset!important; }"),
          (e.innerHTML +=
            " .pages-print-container { box-sizing: border-box; }"),
          t.appendChild(e);
      },
      ...
      _addPrintMapOverlay: function (t, e, r, n, i) {
        (this.__overlay__ = document.createElement("div")),
          (this.__overlay__.className =
            this._map.getContainer().className + " leaflet-print-overlay"),
          document.body.appendChild(this.__overlay__),
          this.__overlay__.appendChild(this._addPrintCss(t, e, n));
        var o = document.createElement("div");
        if (
          ((o.className = "grid-print-container"),
          (o.style.width = "100%"),
          (o.style.display = "grid"),
          this._setupPrintMapHeight(o, r, n),
        ...
        if (
          this.options.pagesSelector &&
          document.querySelectorAll(this.options.pagesSelector).length
        ) {
          ...
          this._setupPrintPagesWidth(o, r, n), this.__overlay__.appendChild(o);
        ...
        var h = L.Control.BrowserPrint.Utils.cloneBasicOptionsWithoutLayers(
          this._map.options
        );
        return (
          (h.maxZoom = this._map.getMaxZoom()),
      ...
      _setupPrintMap: function (t, e, r, n, i) {
        ...
        for (var l in n) {
          ...
          n[l] = n[l].map(function (t) {
            ...
            if (e) {
              if (
                (t instanceof L.Popup
                  ? (t.isOpen ||
                      (t.isOpen = function () {
                        return this._isOpen;
                      }),
                    t.isOpen() && !p && a.push({ source: t._source, popup: e }))
                  : e.addTo(o),
                (s[t._leaflet_id] = e),
                t instanceof L.Layer)
              ) {
                var r = t.getTooltip();
                r &&
                  (e.bindTooltip(r.getContent(), r.options),
        ...
        for (var c = 0; c < a.length; c++) {
          ...
          if (u.source) {
            ...
            d &&
              d.bindPopup &&
              d.openPopup &&
              s[u.source._leaflet_id]
                .bindPopup(u.popup)
                .openPopup(u.popup.getLatLng());
          }
        }
        return { map: o, objects: n };
      },
      _isTilesLoading: function (t) {
        return parseFloat(L.version) > 1
          ? this._getLoadingLayers(t)
          : t._tilesToLoad || t._tileLayersToLoad;
      },
      ...
      (L.control.browserPrint = function (t) {
        if (
          ...
          t && t.printModes && (!t.printModes.filter || !t.printModes.length))
        )
        ...
        return (
          t.printModesNames &&
            console.warn(
              "'printModesNames' option is obsolete. Please use 'L.control.browserPrint.mode.*(/*Title*/)' shortcut instead. Please check latest release and documentation."
            ),
    ...
    L.Control.BrowserPrint.Utils = {
      ...
      initialize: function () {
        (this._knownRenderers = {}),
          ...
          this.registerLayer(L.Popup, "L.Popup", function (t, e) {
            return L.popup(e.cloneOptions(t.options))
              .setLatLng(t.getLatLng())
      ...
      cloneLayer: function (t) {
        ...
        return (
          r ||
          ((e = t._group
            ? this.__getFactoryObject(t._group, !0)
            : this.__getFactoryObject(t)) && (e = e.builder(t, this)),
          e)
        );
      },
      getType: function (t) {
      ...
      __getFactoryObject: function (t, e) {
        ...
        for (r = 0; r < this._cloneFactoryArray.length; r++) {
          if ((i = this._cloneFactoryArray[r]).type && t instanceof i.type)
            return i;
        }
        for (r = 0; r < this._cloneRendererArray.length; r++) {
          var i;
          if ((i = this._cloneRendererArray[r]).type && t instanceof i.type)
            return null;
        }
      ...
      __unknownLayer__: function () {
        console.warn(
          "Unknown layer, cannot clone this layer. Leaflet version: " +
            L.version
        ),
          console.info(
            "For additional information please refer to documentation on: https://github.com/Igor-Vladyka/leaflet.browser.print."
          ),
          console.info(
            "-------------------------------------------------------------------------------------------------------------------"
          );
  ...
  function (t, e) {
    (L.Control.BrowserPrint.Size = {
      A: { Width: 840, Height: 1188 },
      B: { Width: 1e3, Height: 1414 },
      C: { Width: 916, Height: 1296 },
      D: { Width: 770, Height: 1090 },
      ...
      (L.Control.BrowserPrint.Mode = function (t, e, r, n, i) {
        ...
        (this.Mode = t),
          ...
          (this.PageSeries =
            -1 != ["A", "B", "C", "D"].indexOf(this.PageSize[0])
              ? this.PageSize[0]
              : ""),
          (this.PageSeriesSize = this.PageSize.substring(
            this.PageSeries.length
          )),
          (this.Action =
            n ||
            function (t, e) {
      ...
      (L.Control.BrowserPrint.Mode.prototype.getPageMargin = function (t) {
        var e,
          r = this.getPaperSize(),
        ...
        if (this.PageSeries) {
          ...
          return (
            this.PageSeriesSize &&
              ...
              (n = this.PageSeriesSize % 2 == 1)
                ? ((e /= this.PageSeriesSize - 1 || 1),
                  (r /= this.PageSeriesSize + 1))
                : ((e /= this.PageSeriesSize), (r /= this.PageSeriesSize))),
            { Width: n ? r : e, Height: n ? e : r }
          );
        }
      ...
      (L.Control.BrowserPrint.Mode.prototype.getSize = function () {
        ...
        return (
          (t.Width = Math.floor(t.Width - e) + "mm"),
          (t.Height = Math.floor(t.Height - e) + "mm"),
          t
        );
      }),
      (L.control.browserPrint.mode = function (t, e, r, n, i) {
      ...
      (L.control.browserPrint.mode.portrait = function (t, e, r) {
        return L.control.browserPrint.mode(
          L.Control.BrowserPrint.Mode.Portrait,
          t,
          e,
          r,
